<nav class="fixed z-50 top-0 left-0 right-0 bg-white rounded">
        ...
        <div class="flex justify-center items-center space-x-8 py-4">
            {{-- <a href="/" class="hover:text-teal-500 inline-flex items-center"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" viewBox="0 0 20 20" fill="currentColor">
                ...
                <span class="text-black  font-semibold flex gap-4">
                    <a href="" class="text-teal-600 hover:text-teal-400 flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
    ...
    <div class="flex justify-between px-8">
        ...
        <div>
            <a href="/cart" class="flex items-center justify-center px-4 py-4 rounded-md text-sm font-bold text-white bg-green-500 hover:bg-green-600"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 inline mr-1" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M3 1a1 1 0 000 2h1.22l.305 1.222a.997.997 0 00.01.042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 0 000-2H6.414l1-1H14a1 1 0 00.894-.553l3-6A1 1 0 0017 3H6.28l-.31-1.243A1 1 0 005 1H3zM16 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM6.5 18a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" />
                </svg>
                <span>Keranjang</span>
                @auth
                <div class="bg-rose-600 rounded-full p-3 w-3 h-3 inline-flex items-center justify-center ml-1 font-bold text-white text-xs">{{ \App\Models\Cart::where('user_id', Auth::user()->id)->count() }}</div>      
                @endauth
            </a>
        </div>
    </div>
