<nav class="fixed z-50 top-0 left-0 right-0 bg-white rounded">
    ...
    <div class="flex justify-between px-8">
        ...
        <div>
            <a href="/cart" class="flex items-center justify-center bg-teal-400 px-4 py-4 rounded-sm font-semibold hover:bg-teal-300"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 inline mr-1" viewBox="0 0 20 20" fill="currentColor">
