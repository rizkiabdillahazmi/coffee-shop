    ...
    <div>
      <span class="relative z-0 inline-flex mt-2 shadow-sm lg:mt-0">
        ...
        <span aria-current="page">
          <span
            class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium leading-5 text-white bg-teal-600 border border-gray-300 dark:text-white dark:border-secondary-600 dark:bg-secondary-700">{{ $page }}</span>
        </span>
        @else
