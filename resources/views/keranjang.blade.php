    ...
    <div class="max-w-screen-xl mx-auto">
        ...
        <div class="w-full mx-auto">
            ...
            <div class="flex justify-between items-start">
                    ...
                    <div class="mb-8 flex justify-between bg-white rounded-lg">
                        ...
                        <div class="w-2/3 p-5 flex flex-col justify-between">
                            <div>
                                ...
                                @endif
                                <div id="sub-total" class="text-green-600 text-lg font-bold">@money($cart->sub_total)
                                </div>
                            </div>
                            <div class="flex justify-between">
                                <div class="font-bold flex gap-2 justify-start items-center">
                                    ...
                                    <form action="{{ url('updatejumlah', $cart->id) }}" method="POST"
                                        ...
                                        @csrf
                                        <input id="jumlah" type="number" min="1" max="" name="jumlah"
                                            value="{{ $cart->jumlah }}"
                ...
                <div class="w-[35%] px-4 py-5 rounded-md bg-white border-4 border-green-400 shadow-md">
                    <div class="text-xl font-bold">Konfirmasi Pesanan</div>
                    <div class="mt-4 mb-8 font-semibold text-slate-600">Silahkan klik tombol konfirmasi untuk melihat
                        jumlah dan harga total produk yang akan dipesan</div>
                    <div class="flex justify-between">
                        <form action="">
                            <button type="submit"
