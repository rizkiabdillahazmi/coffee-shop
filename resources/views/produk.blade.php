                    ...
                    <div class="swiper-slide">
                        <div class="flex flex-col justify-center items-center bg-white px-8 py-6 rounded-md mx-5 border-4 border-transparent hover:border-teal-500">
                            <div class="relative">
                                ...
                                <img src="https://source.unsplash.com/random/160x160/?drink" alt="" class="w-40">
                            </div>
                            <span class="text-green-500">Tersedia</span>
                            <a href="" class="font-bold text-lg text-center">Sweet Blueberry</a>
                            <span class="text-teal-600 text-lg font-bold">Rp. 10000</span>
                    ...
                    <div class="swiper-slide">
                        <div class="flex flex-col justify-center items-center bg-white px-8 py-6 rounded-md mx-5 border-4 border-transparent hover:border-teal-500">
                            <div class="relative">
                                ...
                                <img src="https://source.unsplash.com/random/160x160/?coffee" alt="" class="w-40">
                            </div>
                            <span class="text-green-500">Tersedia</span>
                            <a href="" class="font-bold text-lg text-center">Sweet Blueberry</a>
                            <span class="text-teal-600 text-lg font-bold">Rp. 10000</span>
                    ...
                    <div class="swiper-slide">
                        <div class="flex flex-col justify-center items-center bg-white px-8 py-6 rounded-md mx-5 border-4 border-transparent hover:border-teal-500">
                            <div class="relative">
                                ...
                                <img src="https://source.unsplash.com/random/160x160/?tea" alt="" class="w-40">
                            </div>
                            <span class="text-green-500">Tersedia</span>
                            <a href="" class="font-bold text-lg text-center">Sweet Blueberry</a>
                            <span class="text-teal-600 text-lg font-bold">Rp. 10000</span>
                    ...
                    <div class="swiper-slide">
                        <div class="flex flex-col justify-center items-center bg-white px-8 py-6 rounded-md mx-5 border-4 border-transparent hover:border-teal-500">
                            <div class="relative">
                                ...
                                <img src="https://source.unsplash.com/random/160x160/?burger" alt="" class="w-40">
                            </div>
                            <span class="text-green-500">Tersedia</span>
                            <a href="" class="font-bold text-lg text-center">Sweet Blueberry</a>
                            <span class="text-teal-600 text-lg font-bold">Rp. 10000</span>
                    ...
                    <div class="swiper-slide">
                        <div class="flex flex-col justify-center items-center bg-white px-8 py-6 rounded-md mx-5 border-4 border-transparent hover:border-teal-500">
                            <div class="relative">
                                ...
                                <img src="https://source.unsplash.com/random/160x160/?rice" alt="" class="w-40">
                            </div>
                            <span class="text-green-500">Tersedia</span>
                            <a href="" class="font-bold text-lg text-center">Sweet Blueberry</a>
                            <span class="text-teal-600 text-lg font-bold">Rp. 10000</span>
